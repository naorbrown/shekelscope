...
import { calculateIncomeTax } from '@/modules/tax-engine/income-tax';
import { loadTaxData } from '@/modules/data/loader';

const data = loadTaxData(2025);
const brackets = data.taxRates.incomeTaxBrackets;
const surtax = data.taxRates.surtax;
